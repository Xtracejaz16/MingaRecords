    ...
    <div className="fixed bottom-0 w-full h-24 z-50 bg-surface/90 backdrop-blur-xl border-t border-primary/20 flex items-center px-8 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex-1 flex flex-col items-center gap-3">
        ...
        <div className="flex items-center gap-8">
          ...
          <button
            type="button"
            className="w-10 h-10 bg-[#C8860A] text-on-primary flex items-center justify-center rounded-full hover:scale-105 active:scale-95 transition-transform cursor-pointer"
      ...
      <div className="w-1/4 flex justify-end items-center gap-6">
        <div className="flex items-center gap-2">
          ...
          >
            <div
              className="absolute inset-y-0 left-0 bg-[#C8860A]/40"
              style={{ width: `${volume}%` }}
            />
          </div>
        </div>
