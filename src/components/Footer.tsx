      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-8 mb-16">
            <a className="text-koguiCream/60 hover:text-muiscaGold transition-colors" href="#" aria-label="Instagram">
            ...
            <a className="text-koguiCream/60 hover:text-muiscaGold transition-colors" href="#" aria-label="YouTube">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
